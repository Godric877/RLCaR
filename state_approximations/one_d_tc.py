...
class StateOneDTileCoding():
    ...
    def __init__(self,
        ...
        self.feature_dims = self.num_tilings*self.num_tiles_per_tiling
        self.feature_array = np.zeros(shape=(2))
        self.feature_array[0] = self.num_tilings
        self.feature_array[1] = self.num_tiles_per_tiling
